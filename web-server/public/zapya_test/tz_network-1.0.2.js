...
function init(self) {
    ...
    pomelo.init({
        ...
        is_connected = true;
        var route = "connector.CS_erShiYiDianHandler.join";
        pomelo.request(route, {
            ...
            console.log("connector.CS_erShiYiDianHandler.join success " + data.users)
            if (data.error) {
                return;
            }
        });
...
NetWork.prototype = { // 定义Person的prototype域
    ...
    sendMessage: function (data) {
        ...
        if (is_connected) {
            ...
            var route = "game.HS_erShiYiDianHandler.message";
            pomelo.request(route, {
                data: jsonStr
            }, function (data) {
