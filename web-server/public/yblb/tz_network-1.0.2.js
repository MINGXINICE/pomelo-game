...
function init(self) {
    ...
    pomelo.init({
        ...
        is_connected = true;
        var route = "connector.C_yiBuLiangBuHandler.join";
        pomelo.request(route, {
            ...
            console.log("connector.C_yiBuLiangBuHandler.join success " + data.users)
            if (data.error) {
                return;
            }
        });
    });
    pomelo.on("onconnected", function (data) {
...
NetWork.prototype = { // 定义Person的prototype域
    ...
    sendMessage: function (data) {
        if (is_connected) {
            ...
            var route = "game.H_yiBuLiangBuHandler.message";
            pomelo.request(route, {
                data: jsonStr
            }, function (data) {
