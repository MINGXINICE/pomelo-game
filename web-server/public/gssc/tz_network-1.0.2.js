...
function init(self) {
    ...
    pomelo.init({
        ...
        is_connected = true;
        var route = "connector.C_gaoSuSaiCheHandler.join";
        pomelo.request(route, {
            ...
            console.log("connector.C_gaoSuSaiCheHandler.join success " + data.users)
            if (data.error) {
                return;
            }
        });
...
NetWork.prototype = { // 定义Person的prototype域
    ...
    sendMessage: function (data) {
        ...
        if (is_connected) {
            ...
            var route = "game.H_gaoSuSaiCheHandler.message";
            pomelo.request(route, {
                data: jsonStr
            }, function (data) {
