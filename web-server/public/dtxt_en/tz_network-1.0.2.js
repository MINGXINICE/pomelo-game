...
function init(self) {
    ...
    pomelo.init({
        ...
        is_connected = true;
        var route = "connector.C_daTouXiaoTouHandler.join";
        pomelo.request(route, {
            ...
            console.log("connector.C_daTouXiaoTouHandler.join success " + data.users)
            if (data.error) {
                return;
            }
        });
...
NetWork.prototype = { // 定义Person的prototype域
    ...
    sendMessage: function (data) {
        if (is_connected) {
            ...
            var route = "game.H_daTouXiaoTouHandler.message";
            pomelo.request(route, {
                data: jsonStr
            }, function (data) {
