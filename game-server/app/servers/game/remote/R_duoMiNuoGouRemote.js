module.exports = function (app) {
    return new duoMiNuoGouRemote(app);
};
var consts = require('../../../consts/consts');

var duoMiNuoGouRemote = function (app) {
    this.app = app;
...
duoMiNuoGouRemote.prototype.join = function (msg, sid, name, flag, cb) {
...
duoMiNuoGouRemote.prototype.kick = function (uid, sid, rid, cb) {
    ...
    if (!!channel) {
        ...
        var winmsg = {
            msgId:consts.dmng.MsgId.msgId_gameOver,
