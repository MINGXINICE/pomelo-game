module.exports = function (app) {
    return new erShiYiDianRemote(app);
};

var consts = require('../../../consts/consts');

var erShiYiDianRemote = function (app) {
    this.app = app;
...
erShiYiDianRemote.prototype.join = function (msg, sid, name, flag, cb) {
...
erShiYiDianRemote.prototype.kick = function (uid, sid, rid, cb) {
