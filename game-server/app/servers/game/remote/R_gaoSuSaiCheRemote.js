module.exports = function (app) {
    return new gaoSuSaiCheRemote(app);
};
var consts = require('../../../consts/consts');

var gaoSuSaiCheRemote = function (app) {
    this.app = app;
...
gaoSuSaiCheRemote.prototype.join = function (msg, sid, name, flag, cb) {
    ...
    if (users.length == 2) {
        ...
        param = {
            msgId: consts.gssc.MsgId.msgId_playersInfo,
...
gaoSuSaiCheRemote.prototype.kick = function (uid, sid, rid, cb) {
    ...
    if (!!channel) {
        ...
        var winmsg = {
            msgId: consts.gssc.MsgId.msgId_gameOver,
