module.exports = function (app) {
    return new daTouXiaoTouRemote(app);
};

var consts = require('../../../consts/consts');

var daTouXiaoTouRemote = function (app) {
    this.app = app;
...
daTouXiaoTouRemote.prototype.join = function (msg, sid, name, flag, cb) {
    ...
    if (users.length == 2) {
        ...
        param = {msgId: consts.dtxt.MsgId.msgId_playersInfo};
...
daTouXiaoTouRemote.prototype.kick = function (uid, sid, rid, cb) {
