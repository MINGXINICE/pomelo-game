module.exports = function (app) {
    return new fanFanLeRemote(app);
};
var consts = require('../../../consts/consts');

var fanFanLeRemote = function (app) {
    this.app = app;
...
fanFanLeRemote.prototype.join = function (msg, sid, name, flag, cb) {
    ...
    if (users.length == 2) {
        ...
        param = {
            msgId: consts.ffl.MsgId.msgId_playerInfo,
...
fanFanLeRemote.prototype.kick = function (uid, sid, rid, cb) {
    ...
    if (!!channel) {
        ...
        var winmsg = {
            msgId:consts.ffl.MsgId.msgId_exit,
