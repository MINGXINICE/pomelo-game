module.exports = function (app) {
    return new yiBuLiangBuRemote(app);
};

var consts = require('../../../consts/consts');

var yiBuLiangBuRemote = function (app) {
    this.app = app;
...
yiBuLiangBuRemote.prototype.join = function (msg, sid, name, flag, cb) {
    ...
    if (users.length == 2) {
        ...
        param = { msgId: consts.yblb.MsgId.msgId_playersInfo };
...
yiBuLiangBuRemote.prototype.kick = function (uid, sid, rid, cb) {
