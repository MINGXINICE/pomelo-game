module.exports = function (app) {
    return new xiaoZhuanKuaiRemote(app);
};
var consts = require('../../../consts/consts');

var xiaoZhuanKuaiRemote = function (app) {
    this.app = app;
...
xiaoZhuanKuaiRemote.prototype.join = function (msg, sid, name, flag, cb) {
...
xiaoZhuanKuaiRemote.prototype.kick = function (uid, sid, rid, cb) {
    ...
    if (!!channel) {
        ...
        var winmsg = {
            msgId:consts.xzk.MsgId.msgId_exit,
