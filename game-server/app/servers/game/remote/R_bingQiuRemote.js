module.exports = function (app) {
    return new bingQiuRemote(app);
};

var consts = require('../../../consts/consts');

var bingQiuRemote = function (app) {
    this.app = app;
...
bingQiuRemote.prototype.join = function (msg, sid, name, flag, cb) {
    ...
    if (users.length == 2) {
        ...
        param = {msgId: consts.bingqiu.MsgId.msgId_playersInfo};
...
bingQiuRemote.prototype.kick = function (uid, sid, rid, cb) {
